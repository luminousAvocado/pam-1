...
INSERT INTO Employees (EmployeeId, Username, Name, FirstName, LastName, Email, IsAdmin, IsApprover, ProcessingUnitId)
    VALUES (2, N'e123456', N'John Doe (e123456)', N'John', N'Doe', N'jdoe1@localhost.localdomain', 0, 0, 1)
INSERT INTO Employees (EmployeeId, Username, Name, FirstName, LastName, Email, IsAdmin, IsApprover, ProcessingUnitId)
    VALUES (3, N'e234567', N'Jane Doe (e234567)', N'Jane', N'Doe', N'jdoe2@localhost.localdomain', 0, 0, 2)
